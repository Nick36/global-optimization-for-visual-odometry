...
public:
    ...
    void compOptSE3(FrameHessian* reference, FrameHessian* target, CalibHessian* HCalib,
...
private:
    ...
    float gaussNewton(int lvl, Mat66f &H_out, Vec6f &b_out, size_t &true_energy_entries_out,
            const SE3 &refToNew, Vec2f affL);
