...
hvalues2, hbase2 = np.histogram(values2, bins=50)
...
# evaluate the histogram
hvalues1, hbase1 = np.histogram(values1, bins=50)
#evaluate the cumulative
...
# evaluate the histogram
hvalues3, hbase3 = np.histogram(values3, bins=50)
#evaluate the cumulative
...
ax.legend(loc=4)
ax.set_xlabel('Absolute Trajectory Error')
