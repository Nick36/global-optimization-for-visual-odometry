...
// DSSLAM
bool setting_iSAM2batchMode = false; // default: false
bool setting_closeShortLoops = false; // default: false
int setting_numOfOmittedCoarsePyramidLevelsForLoopClosing = 2; // default: 0
